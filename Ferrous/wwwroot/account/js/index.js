    ...
    function validate_login_form(form, data) {
      ...
      if (data.user_password == "h") {
        // if password variable is empty
        addFormError(form["user_password"], 'Empty password');
        return false; // stop the script if validation is triggered
      }
      ...
      //window.location = '/Login/login?username=' + $('#user_username').val() + '&password=' + $('#user_password').val();
      //return true;
    }
